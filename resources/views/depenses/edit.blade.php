...
@section('title', 'Modifier dépense - MyGest')
        ...
        <form method="POST" action="{{ route('depenses.update', $depense) }}">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:18px;">
                <div>
                    ...
                    <input type="text" name="numero_depense" value="{{ old('numero_depense', $depense->numero_depense) }}" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;transition:all .25s ease;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
                ...
                <div>
                    ...
                    <input type="date" name="date_depense" value="{{ old('date_depense', $depense->date_depense ? \Carbon\Carbon::parse($depense->date_depense)->format('Y-m-d') : '') }}" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;transition:all .25s ease;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
            ...
            <div style="margin-bottom:18px;">
                ...
                <input type="text" name="objet" value="{{ old('objet', $depense->objet) }}" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;transition:all .25s ease;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:18px;">
                <div>
                    ...
                    <select name="categorie_depense_id" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;cursor:pointer;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
                        ...
                        @foreach($categories as $id => $libelle)
                            <option value="{{ $id }}" {{ old('categorie_depense_id', $depense->categorie_depense_id) == $id ? 'selected' : '' }} style="color:#000;">{{ $libelle }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="montant" value="{{ old('montant', $depense->montant) }}" min="0" step="1" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;transition:all .25s ease;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
            ...
            <div style="margin-bottom:18px;">
                ...
                <select name="mode_paiement" id="mode_paiement" onchange="toggleBanque()" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;cursor:pointer;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
                    @foreach($modes as $m)
                        <option value="{{ $m->value }}" {{ old('mode_paiement', $depense->mode_paiement?->value) == $m->value ? 'selected' : '' }} style="color:#000;">{{ $m->value }}</option>
                    @endforeach
                </select>
            ...
            <div id="banque_wrapper" style="margin-bottom:18px;display:none;">
                ...
                <select name="banque_id" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;cursor:pointer;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
                    ...
                    @foreach($banques as $id => $nom)
                        <option value="{{ $id }}" {{ old('banque_id', $depense->banque_id) == $id ? 'selected' : '' }} style="color:#000;">{{ $nom }}</option>
                    @endforeach
                </select>
                ...
                <div>
                    ...
                    <select name="contact_id" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;cursor:pointer;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
                        ...
                        @foreach($contacts as $id => $raison)
                            <option value="{{ $id }}" {{ old('contact_id', $depense->contact_id) == $id ? 'selected' : '' }} style="color:#000;">{{ $raison }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="statut" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;cursor:pointer;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
                        @foreach($statuts as $s)
                            <option value="{{ $s->value }}" {{ old('statut', $depense->statut?->value) == $s->value ? 'selected' : '' }} style="color:#000;">{{ $s->value }}</option>
                        @endforeach
                    </select>
            ...
            <div style="margin-bottom:18px;">
                ...
                <select name="agence_id" style="width:100%;padding:10px 14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:10px;font-size:13px;font-family:inherit;color:#fff;outline:none;cursor:pointer;box-sizing:border-box;" onfocus="this.style.borderColor='#3b82f6'" onblur="this.style.borderColor='rgba(255,255,255,.08)'">
                    ...
                    @foreach($agences as $id => $nom)
                        <option value="{{ $id }}" {{ old('agence_id', $depense->agence_id) == $id ? 'selected' : '' }} style="color:#000;">{{ $nom }}</option>
                    @endforeach
                </select>
