    ...
    <div style="margin-bottom:20px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:20px;">
            <div style="background:rgba(59,130,246,.08);border:1px solid rgba(59,130,246,.15);border-radius:12px;padding:16px;text-align:center;">
                ...
                <div style="font-size:11px;color:rgba(255,255,255,.45);text-transform:uppercase;letter-spacing:.4px;margin-top:2px;">Total</div>
            </div>
            <div style="background:rgba(74,222,128,.08);border:1px solid rgba(74,222,128,.15);border-radius:12px;padding:16px;text-align:center;">
                <div style="font-size:24px;font-weight:700;color:#4ade80;">{{ $stats['actif'] }}</div>
                <div style="font-size:11px;color:rgba(255,255,255,.45);text-transform:uppercase;letter-spacing:.4px;margin-top:2px;">Actif</div>
            </div>
            <div style="background:rgba(251,191,36,.08);border:1px solid rgba(251,191,36,.15);border-radius:12px;padding:16px;text-align:center;">
                <div style="font-size:24px;font-weight:700;color:#facc15;">{{ $stats['en_cours'] }}</div>
                <div style="font-size:11px;color:rgba(255,255,255,.45);text-transform:uppercase;letter-spacing:.4px;margin-top:2px;">En cours</div>
            </div>
            <div style="background:rgba(148,163,184,.08);border:1px solid rgba(148,163,184,.15);border-radius:12px;padding:16px;text-align:center;">
                <div style="font-size:24px;font-weight:700;color:#94a3b8;">{{ $stats['termine'] }}</div>
                <div style="font-size:11px;color:rgba(255,255,255,.45);text-transform:uppercase;letter-spacing:.4px;margin-top:2px;">Terminé</div>
            </div>
            <div style="background:rgba(248,113,113,.08);border:1px solid rgba(248,113,113,.15);border-radius:12px;padding:16px;text-align:center;">
                <div style="font-size:24px;font-weight:700;color:#f87171;">{{ $stats['annule'] }}</div>
                <div style="font-size:11px;color:rgba(255,255,255,.45);text-transform:uppercase;letter-spacing:.4px;margin-top:2px;">Annulé</div>
            </div>
            @if($stats['total_cout'] > 0)
            <div style="background:rgba(74,222,128,.08);border:1px solid rgba(74,222,128,.15);border-radius:12px;padding:16px;text-align:center;">
                <div style="font-size:16px;font-weight:700;color:#4ade80;">{{ number_format($stats['total_cout'], 0, ',', ' ') }}</div>
                <div style="font-size:11px;color:rgba(255,255,255,.45);text-transform:uppercase;letter-spacing:.4px;margin-top:2px;">Coût total</div>
            </div>
            @endif
        </div>
