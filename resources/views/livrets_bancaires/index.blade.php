    ...
    <div style="margin-bottom:20px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:12px;margin-bottom:20px;">
            ...
            <div style="background:rgba(74,222,128,.08);border:1px solid rgba(74,222,128,.15);border-radius:12px;padding:16px;text-align:center;">
                <div style="font-size:20px;font-weight:700;color:#4ade80;">{{ number_format($stats['depots'], 0, ',', ' ') }}</div>
                <div style="font-size:11px;color:rgba(255,255,255,.45);text-transform:uppercase;letter-spacing:.4px;margin-top:2px;">Dépôts</div>
            </div>
            <div style="background:rgba(248,113,113,.08);border:1px solid rgba(248,113,113,.15);border-radius:12px;padding:16px;text-align:center;">
                <div style="font-size:20px;font-weight:700;color:#f87171;">{{ number_format($stats['retraits'], 0, ',', ' ') }}</div>
                <div style="font-size:11px;color:rgba(255,255,255,.45);text-transform:uppercase;letter-spacing:.4px;margin-top:2px;">Retraits</div>
            </div>
            <div style="background:rgba(147,51,234,.08);border:1px solid rgba(147,51,234,.15);border-radius:12px;padding:16px;text-align:center;">
                <div style="font-size:20px;font-weight:700;color:#a78bfa;">{{ number_format($stats['solde'], 0, ',', ' ') }}</div>
                <div style="font-size:11px;color:rgba(255,255,255,.45);text-transform:uppercase;letter-spacing:.4px;margin-top:2px;">Solde</div>
            </div>
        </div>
